...
class SchoolPeriodStatDashboard < Administrate::BaseDashboard
  # ATTRIBUTE_TYPES
  ...
  # Overwrite this method to customize how school period stats are displayed
  # across all pages of the admin dashboard.
  #
  # def display_resource(school_period_stat)
  #   "SchoolPeriodStat ##{school_period_stat.id}"
  # end
end
